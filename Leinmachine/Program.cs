/*
    ...
    Based on UltraSkull1000/DiscordNetBotExample
    ---------------------------------------
...
namespace Leinmachine; // All elements of the program should be under this namespace. Feel free to rename.

public class Leinmachine() // I recommend changing the name of this class to match the namespace above. 
{
    ...
    public static async Task MainAsync() // Start of Asynchronous operation
    {
        ...
        Print($"https://discord.com/oauth2/authorize?client_id={_client.CurrentUser.Id}&scope=bot&permissions=378161667072");
